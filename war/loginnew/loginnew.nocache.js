...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "loginnew" because\n';
  ...
  $wnd.__gwt_activeModules['loginnew'] = {
    'moduleName' : 'loginnew',
    'bindings' : function() {
      return {};
    }
 ...
 * "/loginnew.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['loginnew'].superdevmode = true;

  var expectedSuffix = '/loginnew.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + loginnew + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:loginnew';
  var devModeSessionKey = '__gwtDevModeSession:loginnew';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/loginnew/loginnew.nocache.js';
  ...
  $wnd.__gwt_activeModules['loginnew'].canRedirect = true;
  $wnd.__gwt_activeModules['loginnew'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/loginnew?user.agent=' + ua + '&_callback=' + callback;
